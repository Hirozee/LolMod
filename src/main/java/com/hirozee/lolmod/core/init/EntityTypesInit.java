...
public class EntityTypesInit {
  ...
  /*public static final RegistryObject<EntityType<BoomerProjectileEntity>> BOOMER_PROJECTILE = ENTITY_TYPES.register("boomer_projectile",
		  () -> EntityType.Builder.<BoomerProjectileEntity>of(BoomerProjectileEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).build((new ResourceLocation("lolmod", "explosive_charge")).toString()));
